...
from algorithm.extractor import *
import torch as th
from VisFly.envs.RacingEnv import RacingEnv2

from VisFly.utils.launcher import rl_parser, training_params
from algorithm.diff_grad_off_policy_algorithm import MTD
...
def main():
    with open(os.path.dirname(os.path.abspath(__file__))+'/cfg/mtd.yaml', 'r') as file:
    ...
    # Testing mode with a trained weight
        ...
        env = RacingEnv2(**config["eval_env"])
        model = MTD.load(test_model_path, env=env)
