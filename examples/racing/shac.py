...
def main():
    with open(os.path.dirname(os.path.abspath(__file__))+'/cfg/shac.yaml', 'r') as file:
    ...
    # Testing mode with a trained weight
        ...
        config["test"]["render_kwargs"]=env.targets
        model = shac.load(test_model_path, env=env)
